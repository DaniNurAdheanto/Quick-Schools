...
export default function StudentPersonalAttendanceView({
  ...
  return (
    <div className="space-y-3.5 sm:space-y-4 animate-in fade-in duration-300">
      ...
      {/* ----------------------------------------------------------------- */}
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-gray-950 via-[#190C36] to-[#2E125B] p-4 sm:p-5 md:p-6 text-white shadow-lg shadow-purple-950/20 border border-white/10">
        {/* Glow ambient background ornaments */}
        <div className="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 rounded-full bg-[#531FFF]/25 blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-1/3 -mb-16 w-48 h-48 rounded-full bg-emerald-500/15 blur-2xl pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          ...
          <div className="flex items-center sm:items-start gap-3.5 sm:gap-4">
            <div className="relative shrink-0">
              <ProfileAvatar
                ...
                size="xl"
                shape="rounded-xl"
                ring="ring-2 ring-white/30 shadow-md"
              />
              <div className="absolute -bottom-1 -right-1 px-1.5 py-0.5 bg-emerald-500 text-gray-950 font-black text-[8px] rounded-full uppercase tracking-wider shadow">
                Siswa
              </div>
            </div>
            ...
            <div className="space-y-0.5">
              <div className="flex flex-wrap items-center gap-1.5">
                <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-white/10 text-purple-200 border border-white/10 backdrop-blur-md">
                  Kelas {student.className || "10 MIPA 1"}
                </span>
                <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-white/10 text-gray-300 border border-white/10 backdrop-blur-md">
              ...
              <p className="text-xs text-purple-200/80 font-medium flex items-center gap-1.5">
          ...
          <div className="w-full lg:w-auto flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5">
            {todayAttendance ? (
              ...
              <div className="flex items-center gap-2.5 px-3 py-2 bg-amber-500/20 backdrop-blur-md border border-amber-400/30 rounded-lg">
                <div className="w-8 h-8 rounded-lg bg-amber-500/30 text-amber-300 flex items-center justify-center shrink-0">
                  <AlertTriangle className="w-4 h-4" />
                </div>
                <div>
                  <div className="text-[9px] font-bold text-amber-200 uppercase tracking-wider">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 sm:gap-3">
        ...
        <div className="bg-white p-3.5 sm:p-4 rounded-xl border border-gray-100 shadow-xs hover:border-emerald-200 transition-all flex flex-col justify-between">
          ...
          <div className="flex items-baseline gap-1.5">
            <span className="text-xl sm:text-2xl font-black text-gray-900">{stats.hadir}</span>
            <span className="text-[10px] font-bold text-emerald-600">Hari</span>
          </div>
        ...
        <div className="bg-white p-3.5 sm:p-4 rounded-xl border border-gray-100 shadow-xs hover:border-amber-200 transition-all flex flex-col justify-between">
          ...
          <div className="flex items-baseline gap-1.5">
            <span className="text-xl sm:text-2xl font-black text-gray-900">{stats.terlambat}</span>
            <span className="text-[10px] font-bold text-amber-600">Hari</span>
          </div>
          <div className="mt-1.5 text-[10px] font-medium text-gray-400">
        ...
        {/* Izin */}
        <div className="bg-white p-3.5 sm:p-4 rounded-xl border border-gray-100 shadow-xs hover:border-purple-200 transition-all flex flex-col justify-between">
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[10px] sm:text-[11px] font-extrabold text-gray-500 uppercase tracking-wider">
              Izin
            </span>
          ...
          <div className="flex items-baseline gap-1.5">
            <span className="text-xl sm:text-2xl font-black text-gray-900">{stats.izin}</span>
            <span className="text-[10px] font-bold text-purple-600">Hari</span>
          </div>
          <div className="mt-1.5 text-[10px] font-medium text-gray-400">
        ...
        <div className="bg-white p-3.5 sm:p-4 rounded-xl border border-gray-100 shadow-xs hover:border-blue-200 transition-all flex flex-col justify-between">
          ...
          <div className="flex items-baseline gap-1.5">
            <span className="text-xl sm:text-2xl font-black text-gray-900">{stats.sakit}</span>
            <span className="text-[10px] font-bold text-blue-600">Hari</span>
          </div>
          <div className="mt-1.5 text-[10px] font-medium text-gray-400">
        ...
        <div className="col-span-2 sm:col-span-1 lg:col-span-1 bg-gradient-to-br from-[#531FFF] to-[#3910A3] p-3.5 sm:p-4 rounded-xl text-white shadow-sm shadow-[#531FFF]/20 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[10px] sm:text-[11px] font-extrabold text-purple-200 uppercase tracking-wider">
              Persentase
            </span>
            <div className="w-7 h-7 rounded-lg bg-white/15 text-white flex items-center justify-center font-bold">
              <TrendingUp className="w-3.5 h-3.5" />
            </div>
          </div>
          <div>
            <div className="flex items-baseline gap-1">
              <span className="text-xl sm:text-2xl font-black text-white">{stats.percentage}%</span>
            </div>
          ...
          <div className="mt-1.5 flex items-center justify-between text-[10px] font-bold text-purple-200">
            <span>{stats.percentage >= 90 ? "🌟 Sangat Baik" : stats.percentage >= 80 ? "👍 Disiplin" : "⚠️ Tingkatkan"}</span>
      ...
      {/* ----------------------------------------------------------------- */}
      <div className="bg-white rounded-xl border border-gray-100 shadow-xs p-3 sm:p-3.5">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-gray-50/80 border border-gray-200 text-gray-900 text-xs font-bold pl-8.5 pr-3 py-2 rounded-lg focus:bg-white focus:ring-2 focus:ring-[#531FFF]/20 focus:border-[#531FFF] focus:outline-none transition-all placeholder:text-gray-400"
            />
          </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <div className="relative min-w-[180px]">
              ...
              <select
                ...
                className="w-full appearance-none bg-gray-50/80 hover:bg-white border border-gray-200 text-gray-900 text-xs font-extrabold pl-8 pr-8 py-2 rounded-lg focus:bg-white focus:ring-2 focus:ring-[#531FFF]/20 focus:border-[#531FFF] focus:outline-none transition-all cursor-pointer shadow-2xs"
              >
            ...
            {(statusFilter !== "Semua" || searchQuery.trim() !== "") && (
              <button
                ...
                className="p-2 bg-gray-100 hover:bg-gray-200 text-gray-600 rounded-lg text-xs font-bold transition-all cursor-pointer"
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-xs overflow-hidden">
        <div className="px-4 sm:px-5 py-3 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
          <div>
        ...
        {finalDisplayRecords.length === 0 ? (
          <div className="p-8 text-center space-y-2.5">
            <div className="w-12 h-12 bg-purple-50 text-[#531FFF] rounded-xl mx-auto flex items-center justify-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-bold text-[#531FFF] hover:underline cursor-pointer pt-1"
            >
              <RotateCcw className="w-3.5 h-3.5" />
          ...
          <div className="divide-y divide-gray-100">
            {finalDisplayRecords.map((rec) => {
              ...
              return (
                <div
                  key={rec.id}
                  className="p-3 sm:p-3.5 hover:bg-purple-50/20 transition-all flex flex-col md:flex-row items-start md:items-center justify-between gap-3"
                >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="relative group shrink-0">
                      <div
                        className="w-12 h-12 sm:w-13 sm:h-13 rounded-lg overflow-hidden bg-gray-100 border border-gray-200 shadow-2xs relative cursor-pointer"
                      ...
                      {rec.faceVerified && (
                        <div
                          className="absolute -bottom-1 -right-1 w-4 h-4 bg-emerald-500 rounded-full border-2 border-white flex items-center justify-center text-white shadow-2xs"
                    ...
                    <div className="space-y-0.5">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span
                          className={cn(
                            "px-2 py-0.5 rounded-full text-[10px] font-black tracking-wide flex items-center gap-1",
                        ...
                        >
                          {isHadir && <CheckCircle2 className="w-2.5 h-2.5" />}
                          {isTerlambat && <Clock className="w-2.5 h-2.5" />}
                          {isIzin && <Calendar className="w-2.5 h-2.5" />}
                          {isSakit && <AlertCircle className="w-2.5 h-2.5" />}
                      ...
                      <div className="flex flex-wrap items-center gap-2.5 text-[11px] text-gray-500 font-medium">
                        ...
                        {rec.faceMatchScore && (
                          <span className="text-[9px] font-bold px-1.5 py-0.5 bg-purple-50 text-[#531FFF] rounded border border-purple-100">
                            AI: {rec.faceMatchScore}%
                          </span>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-2.5 w-full md:w-auto justify-between md:justify-end pt-2 md:pt-0 border-t md:border-t-0 border-gray-100">
                    <div className="text-left md:text-right">
                      <div className="flex items-center md:justify-end gap-1.5 text-[11px] font-extrabold text-gray-800">
                        <MapPin className="w-3 h-3 text-[#531FFF]" />
                        <span>
                          {rec.location?.distance
                            ? `${rec.location.distance} m dari sekolah`
                            : "Lokasi Sekolah"}
                        </span>
                      </div>
                      <div className="text-[10px] text-gray-400 font-medium">
                        {rec.location?.inRadius ? (
                          <span className="text-emerald-600 font-bold">✓ Dalam Radius</span>
                        ) : (
                          <span className="text-amber-600 font-bold">Luar Radius</span>
                        )}
                        {rec.location?.lat && (
                          <span className="ml-1 text-gray-400 font-mono text-[9px]">
                    ...
                    <button
                      type="button"
                      onClick={() => setSelectedProofRecord(rec)}
                      className="px-2.5 py-1.5 bg-purple-50/60 hover:bg-purple-100 text-[#531FFF] border border-purple-200/80 rounded-lg text-[11px] font-bold flex items-center gap-1.5 transition-all cursor-pointer shrink-0"
                    >
      ...
      {selectedProofRecord && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-gray-950/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="relative w-full max-w-lg bg-white rounded-xl shadow-2xl overflow-hidden border border-gray-100 flex flex-col max-h-[90vh]">
            ...
            {/* Modal Header */}
            <div className="px-5 py-3.5 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-gray-900 to-gray-950 text-white shrink-0">
              <div className="flex items-center gap-2.5">
                <div className="w-7 h-7 rounded-lg bg-[#531FFF] flex items-center justify-center text-white">
                  <ShieldCheck className="w-3.5 h-3.5" />
                </div>
                <div>
                  <h3 className="text-xs sm:text-sm font-black">Bukti Absensi & Geolokasi Siswa</h3>
            ...
            <div className="p-4 sm:p-5 overflow-y-auto space-y-3.5">
              {/* Photo Proof */}
              <div className="relative w-full h-52 sm:h-56 rounded-lg overflow-hidden bg-gray-900 border border-gray-100 shadow-inner flex items-center justify-center">
                ...
                {/* Status Overlay */}
                <div className="absolute top-2.5 left-2.5 px-2.5 py-1 bg-black/60 backdrop-blur-md rounded-full text-white text-[11px] font-extrabold flex items-center gap-1.5 border border-white/20">
                  <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                  <span>{selectedProofRecord.status}</span>
                </div>

                {selectedProofRecord.faceMatchScore && (
                  <div className="absolute top-2.5 right-2.5 px-2.5 py-1 bg-purple-900/80 backdrop-blur-md rounded-full text-purple-200 text-[10px] font-extrabold border border-purple-400/30">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex justify-between px-3 py-2 bg-gray-50/80 rounded-lg">
                ...
                {selectedProofRecord.location?.lat && (
                  <div className="flex justify-between px-3 py-2 bg-gray-50/80 rounded-lg">
                    ...
                    <span className="text-gray-700 font-mono font-bold text-[11px]">
                ...
                {selectedProofRecord.notes && (
                  <div className="p-2.5 bg-purple-50/60 border border-purple-100 rounded-lg">
                    <span className="text-[9px] font-extrabold text-[#531FFF] uppercase tracking-wider block mb-0.5">
                      Catatan Siswa / Keterangan
                    </span>
                    <p className="text-gray-800 font-semibold italic text-xs">"{selectedProofRecord.notes}"</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="px-5 py-3 border-t border-gray-100 bg-gray-50/50 flex items-center justify-end">
              <button
                type="button"
                onClick={() => setSelectedProofRecord(null)}
                className="px-4 py-2 bg-gray-900 hover:bg-gray-800 text-white text-xs font-bold rounded-lg transition-all cursor-pointer"
              >
                Tutup
              </button>
            </div>
