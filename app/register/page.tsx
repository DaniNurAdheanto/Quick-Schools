        ...
        <div className="w-full lg:flex-1 flex flex-col justify-center px-10 lg:px-24 xl:px-32 py-12 relative bg-white min-h-screen border-l border-gray-100/50">
          <div className="w-full max-w-[420px] mx-auto">
            ...
            <h2 className="text-[1.75rem] font-bold tracking-tight text-gray-900 mb-1 flex items-center gap-2">
              Buat Akun Baru <span className="text-2xl">🚀</span>
            </h2>
            <p className="text-gray-500 text-sm mb-8">Bergabunglah dengan Quick Schools hari ini.</p>
            ...
            <form className="space-y-4" onSubmit={handleRegister}>
              <div className="space-y-1.5">
                <label className="text-[13px] font-bold text-gray-900" htmlFor="name">Nama Lengkap</label>
              ...
              <div className="space-y-1.5">
                <label className="text-[13px] font-bold text-gray-900" htmlFor="email">Email address</label>
                <div className="relative">
              ...
              <div className="pt-6 text-center">
                <p className="text-[13px] font-medium text-gray-500">
                  Sudah punya akun? <Link href="/" className="text-[#531FFF] hover:underline font-bold">Masuk di sini</Link>
                </p>
              </div>
            </form>
          </div>
