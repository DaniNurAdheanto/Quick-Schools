  ...
  if (!authChecking && currentUser && !isSuperAdmin) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[65vh] p-6 text-center animate-in fade-in duration-300">
        <div className="w-16 h-16 rounded-xl bg-rose-50 border border-rose-200 text-rose-600 flex items-center justify-center shadow-lg shadow-rose-500/10 mb-4">
        ...
        <div className="mt-6 flex items-center gap-3">
          <Link
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-[#531FFF] hover:bg-[#4314cc] text-white rounded-lg text-xs font-bold transition-all shadow-md shadow-[#531FFF]/20 active:scale-95"
          >
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-[1600px] mx-auto w-full h-full space-y-6 sm:space-y-8 animate-in fade-in duration-300 pb-20">
      ...
      {!authChecking && !currentUser && (
        <div className="p-4 sm:p-5 bg-amber-50 border border-amber-200 rounded-lg flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xs">
          <div className="flex items-center gap-3.5">
            <div className="w-10 h-10 rounded-lg bg-amber-100 text-amber-700 flex items-center justify-center shrink-0 shadow-2xs">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-[#531FFF] hover:bg-[#4314cc] text-white rounded-lg text-xs font-bold transition-all shadow-sm shrink-0 active:scale-95 cursor-pointer"
          >
      ...
      {/* Top Header Card */}
      <div className="bg-white rounded-lg p-6 sm:p-7 border border-gray-100 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-5">
        <div className="flex items-center gap-4">
          <div className="w-12 h-12 rounded-lg bg-[#531FFF]/10 text-[#531FFF] flex items-center justify-center shrink-0 border border-[#531FFF]/20 shadow-xs">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="flex items-center gap-2 px-5 py-3 bg-[#531FFF] hover:bg-[#4314cc] text-white rounded-lg font-bold text-xs sm:text-sm shadow-md shadow-[#531FFF]/20 transition-all active:scale-[0.98] shrink-0 cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
        <div className="bg-white border border-gray-100 rounded-lg p-5 sm:p-6 shadow-xs hover:shadow-md transition-all duration-200 flex items-center justify-between">
          <div>
          ...
          <div className="w-12 h-12 rounded-lg bg-purple-50 text-[#531FFF] border border-purple-100 flex items-center justify-center font-bold shadow-2xs">
        ...
        <div className="bg-white border border-gray-100 rounded-lg p-5 sm:p-6 shadow-xs hover:shadow-md transition-all duration-200 flex items-center justify-between">
          ...
          <div className="w-12 h-12 rounded-lg bg-emerald-50 text-emerald-600 border border-emerald-100 flex items-center justify-center font-bold shadow-2xs">
        ...
        <div className="bg-white border border-gray-100 rounded-lg p-5 sm:p-6 shadow-xs hover:shadow-md transition-all duration-200 flex items-center justify-between">
          ...
          <div className="w-12 h-12 rounded-lg bg-rose-50 text-rose-600 border border-rose-100 flex items-center justify-center font-bold shadow-2xs">
        ...
        <div className="bg-white border border-gray-100 rounded-lg p-5 sm:p-6 shadow-xs hover:shadow-md transition-all duration-200 flex items-center justify-between">
          ...
          <div className="w-12 h-12 rounded-lg bg-amber-50 text-amber-600 border border-amber-100 flex items-center justify-center font-bold shadow-2xs">
      ...
      {stats.pendingOnboarding > 0 && (
        <div className="bg-amber-50/90 border border-amber-200/80 rounded-lg p-5 sm:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-xs">
          <div className="flex items-start gap-3.5">
            <div className="w-10 h-10 rounded-lg bg-amber-100 border border-amber-200 text-amber-700 flex items-center justify-center shrink-0 mt-0.5 shadow-2xs">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 px-5 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-lg text-xs font-bold transition-all shadow-xs active:scale-95 shrink-0 cursor-pointer"
          >
        ...
        <div className="p-5 sm:p-6 border-b border-gray-100 bg-gray-50/60 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 bg-white border border-gray-200 rounded-lg text-xs font-medium focus:outline-none focus:ring-2 focus:ring-[#531FFF]/20 focus:border-[#531FFF] transition-all shadow-xs"
            />
            {searchQuery && (
              <button 
                  ...
                  <td colSpan={6} className="px-6 py-16 text-center text-gray-500">
                    <div className="flex flex-col items-center justify-center gap-3">
                      ...
                      <button
                        onClick={handleQuickLoginAdmin}
                        disabled={isLoggingIn}
                        className="px-5 py-2.5 bg-[#531FFF] hover:bg-[#4314cc] text-white rounded-lg text-xs font-bold transition-all shadow-md shadow-[#531FFF]/20 cursor-pointer"
                      >
                  ...
                  return (
                    <tr key={user.id} className="hover:bg-gray-50/70 transition-colors group">
                      ...
                      <td className="px-6 py-4.5 sm:py-5">
                        <div className="flex items-center gap-3.5">
                          <div className={cn(
                            "w-10 h-10 rounded-lg flex items-center justify-center font-black text-sm shrink-0 border shadow-2xs",
                      ...
                      <td className="px-6 py-4.5 sm:py-5 whitespace-nowrap">
                        <span className={cn(
                          "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-[11px] font-bold border shadow-2xs",
                          roleObj.bg, roleObj.text, roleObj.border
                        )}>
                      ...
                      <td className="px-6 py-4.5 sm:py-5 text-center whitespace-nowrap">
                        {user.onboardingCompleted ? (
                          <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded border border-emerald-200/80">
                            <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
                            Selesai
                          </span>
                        ) : (
                          <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-amber-700 bg-amber-50 px-2.5 py-1 rounded border border-amber-200/80">
                      ...
                      <td className="px-6 py-4.5 sm:py-5 text-right whitespace-nowrap">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <button
                            ...
                            className={cn(
                              "p-2 rounded-lg transition-all cursor-pointer border shadow-2xs active:scale-95 flex items-center gap-1 text-xs font-bold",
                              isAktif 
                          ...
                          {(user.status === "Belum Onboarding" || user.onboardingCompleted === false) && (
                            <button
                              ...
                              className="p-2 text-amber-600 hover:text-amber-700 hover:bg-amber-50 rounded-lg transition-colors border border-amber-200 cursor-pointer shadow-2xs"
                            >
                              <Bell className="w-4 h-4" />
                            </button>
                          )}
      ...
      {editModal.open && editModal.data && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="bg-white rounded-lg border border-gray-100 shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-purple-50 text-[#531FFF] border border-purple-100 flex items-center justify-center font-bold">
            ...
            <form onSubmit={handleSaveEdit} className="p-6 space-y-4 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 border border-gray-200 rounded-lg font-medium focus:ring-2 focus:ring-[#531FFF]/20 focus:border-[#531FFF] focus:outline-none"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 border border-gray-200 rounded-lg font-bold text-gray-800 focus:ring-2 focus:ring-[#531FFF]/20 focus:border-[#531FFF] focus:outline-none cursor-pointer"
                >
              ...
              <div className="pt-4 flex items-center justify-end gap-3 border-t border-gray-100">
                <button
                  type="button"
                  onClick={() => setEditModal({ open: false, data: null })}
                  className="px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-bold transition-all"
                >
                  Batal
                </button>
                <button
                  ...
                  className="px-5 py-2.5 bg-[#531FFF] hover:bg-[#4314cc] text-white rounded-lg font-bold transition-all shadow-md shadow-[#531FFF]/20"
                >
      ...
      {createModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs animate-in fade-in duration-200 overflow-y-auto">
          <div className="bg-white rounded-xl border border-gray-100 shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200 my-8">
            <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-gradient-to-r from-purple-50/70 via-white to-indigo-50/40">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-[#531FFF] text-white shadow-md shadow-[#531FFF]/20 flex items-center justify-center font-bold">
            ...
            <form onSubmit={handleSaveCreate} className="p-6 space-y-4 text-xs">
              ...
              <div>
                ...
                <select
                  value={formRole}
                  onChange={(e) => setFormRole(e.target.value)}
                  className="w-full px-3.5 py-2.5 border border-gray-200 rounded-lg font-bold text-gray-800 focus:ring-2 focus:ring-[#531FFF]/20 focus:border-[#531FFF] focus:outline-none cursor-pointer bg-white"
                >
              ...
              <div className="bg-gray-50/70 p-4 rounded-lg border border-gray-200/70 space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 pr-10 border border-gray-200 rounded-lg font-medium bg-white focus:ring-2 focus:ring-[#531FFF]/20 focus:border-[#531FFF] focus:outline-none text-xs"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 p-1.5 rounded-md transition-colors cursor-pointer"
              ...
              <div className="pt-4 flex items-center justify-end gap-3 border-t border-gray-100">
                <button
                  type="button"
                  onClick={() => setCreateModal(false)}
                  className="px-4 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-bold transition-all cursor-pointer"
                >
                  Batal
                </button>
                <button
                  ...
                  className="px-5 py-2.5 bg-[#531FFF] hover:bg-[#4314cc] text-white rounded-lg font-bold transition-all shadow-md shadow-[#531FFF]/20 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {isSubmitting ? (
                    <>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="bg-white rounded-lg border border-gray-100 shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
              <div>
                {(detailModal.data.status === "Belum Onboarding" || detailModal.data.onboardingCompleted === false) && (
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-2 bg-amber-600 hover:bg-amber-700 text-white font-bold rounded-lg text-xs transition-all cursor-pointer shadow-xs"
                  >
              ...
              <button
                onClick={() => setDetailModal({ open: false, data: null })}
                className="px-5 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold rounded-lg text-xs transition-all"
              >
                Tutup
              </button>
            </div>
      ...
      {deleteModal.open && deleteModal.data && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="bg-white rounded-lg border border-gray-100 shadow-2xl w-full max-w-[440px] overflow-hidden animate-in zoom-in-95 duration-200">
            <div className="p-6 text-center space-y-4">
              
              {/* Warning Icon */}
              <div className="w-14 h-14 rounded-lg bg-rose-50 border border-rose-100 text-rose-600 flex items-center justify-center mx-auto shadow-sm">
              ...
              {/* Warning Notice Box */}
              <div className="p-3.5 bg-rose-50 border border-rose-200 rounded-lg text-left text-xs text-rose-800 space-y-1">
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <button
                  ...
                  className="w-full py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-lg text-xs transition-all"
                >
                  Batal
                </button>
                <button
                  ...
                  className="w-full py-2.5 bg-rose-600 hover:bg-rose-700 text-white font-bold rounded-lg text-xs shadow-md shadow-rose-600/20 transition-all"
                >
