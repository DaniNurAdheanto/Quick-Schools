    ...
    <div className="p-4 sm:p-6 md:p-8 max-w-full mx-auto w-full flex-1 flex flex-col min-h-screen bg-gray-50/50 animate-in fade-in duration-300 relative">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4 bg-white p-5 md:p-6 rounded-lg border border-gray-100 shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
          ...
          <button
            ...
            className="flex-1 lg:flex-none flex items-center justify-center gap-2 bg-[#531FFF] hover:bg-[#531FFF]/90 text-white px-4 py-2 rounded-lg text-xs font-bold shadow-md shadow-[#531FFF]/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div className={cn(
                        "w-12 h-12 rounded-lg flex items-center justify-center font-extrabold text-sm shrink-0 border",
                        isActive 
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                      ...
                      {!isActive && (
                        <button
                          ...
                          className="px-4 py-2 bg-gray-900 hover:bg-black text-white text-xs font-bold rounded-lg transition-all shadow-xs"
                        >
                          Set Sebagai Aktif
                        </button>
                      )}
      ...
      {activeTab === "promotion" && (
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-100 shadow-xs p-6 relative overflow-hidden">
            ...
            <div className="mt-6 p-4 rounded-lg bg-purple-50/50 border border-purple-100 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  ...
                  <select
                    ...
                    className="bg-white border border-purple-200 text-purple-900 text-xs font-extrabold rounded-lg py-1.5 px-3 focus:ring-2 focus:ring-[#531FFF]/20"
                  >
              ...
              <button
                ...
                className="flex items-center gap-2 bg-[#531FFF] hover:bg-[#531FFF]/90 text-white px-5 py-2.5 rounded-lg text-xs font-extrabold shadow-md shadow-[#531FFF]/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-5 rounded-lg border border-gray-100 shadow-xs space-y-3">
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 overflow-y-auto animate-in fade-in duration-200">
          <div className="bg-white rounded-lg shadow-2xl border border-gray-200 w-full max-w-md p-6 text-gray-900">
